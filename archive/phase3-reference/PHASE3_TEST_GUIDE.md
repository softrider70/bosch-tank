# bosch-tank Phase 3: Praktischer Test-Guide
...
```
1. ESP32 startet
2. WiFi AP aktiviert → SSID "bosch-tank-ap"
...
I (457) WIFI_NET:   AP:   bosch-tank-ap / 12345678 @ 10.1.1.1
...
|------|--------|----------|
| AP visible | In WiFi-Liste suchen | SSID "bosch-tank-ap" sichtbar |
...
### Problem: mDNS (bosch-tank.local) funktioniert nicht
...
tcpdump -i en0 -n tcp.port==80 -w bosch.pcap

# Später analysieren:
wireshark bosch.pcap
```
...
```
1. "bosch-tank-ap" in WiFi SSID wählen
2. Password: 12345678
3. Safari öffnen
...
```
1. WiFi-Einstellungen → "bosch-tank-ap"
2. Password eingeben
3. Chrome Browser
4. Adresse: 10.1.1.1
