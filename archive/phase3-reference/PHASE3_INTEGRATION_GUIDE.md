# bosch-tank: Phase 3 Integration Guide
...
Phase 3 fügt dem bosch-tank eine vollständige REST API via WiFi hinzu. Das System läuft jetzt:
...
# dann: ping bosch-tank.local

# Linux: install avahi-utils
avahi-browse -a | grep bosch
```
