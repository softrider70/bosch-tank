...
#define NVS_NAMESPACE                   "bosch-tank"
...
// mDNS ermöglicht Zugriff via "bosch-tank.local"
// Hostname wird im WiFi-Router angezeigt
#define MDNS_HOSTNAME                   "bosch-tank"          // z.B. bosch-tank.local
#define MDNS_INSTANCE_NAME              "Bosch Tank System"
...
#define TAG_MAIN                        "bosch-main"
#define TAG_SENSOR                      "bosch-sensor"
#define TAG_VALVE                       "bosch-valve"
#define TAG_SERVER                      "bosch-server"
#define TAG_NVS                         "bosch-nvs"
#define TAG_WIFI                        "bosch-wifi"
